...
//сравнение текста показывает что мой код выдает тот же результат что и ожидается
// но при этом он как бы не совпадает, но без завершения этого урока я не могу приступить к №18
